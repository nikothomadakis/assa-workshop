...
**How to explain a new-business bucket.** Use `query_policies` filtered to the period's entry dates, grouped by age band, to get counts and average liability; compare with the book; then pull the product spec.
