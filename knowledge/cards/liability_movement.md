...
**Materiality.** A bucket is material if it exceeds 10% of the total movement or 1% of the opening liability. Basis change is examined whenever the assumptions register shows a change for the product, regardless of size, because it is a governance item — and because a small net total can hide two larger offsetting changes.
